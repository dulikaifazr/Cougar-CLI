...
const MODEL_FEATURES: Record<string, ModelFeatures> = {
  ...
  // Zhipu GLM models - use max_completion_tokens
  'glm-4.6v-flash': { usesMaxCompletionTokens: true },
  'glm-4-flash': { usesMaxCompletionTokens: true },
  'glm-4': { usesMaxCompletionTokens: true },
  'glm-4v': { usesMaxCompletionTokens: true },
}
